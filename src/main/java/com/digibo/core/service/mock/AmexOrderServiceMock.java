...
/**
 * AmexOrderServiceMock - Mock implementation of AmexOrderService
 * Returns test data without database calls
 */
@Service
@Profile("mock")
public class AmexOrderServiceMock implements AmexOrderService {

    private static final Logger logger = LoggerFactory.getLogger(AmexOrderServiceMock.class);
    ...
    public Map<String, Object> amexorder(String docId) {
        logger.debug("[MOCK] amexorder({})", docId);
        ...
        response.put("infoToCustomer", "AMEX order processed");
    ...
    public int setProcessing(String docId) {
        ...
        return docId != null && docId.startsWith("AMEX") ? 100 : 0;
    }
}
